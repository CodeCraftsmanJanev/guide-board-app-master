...
public class QueryCarInfoRequest extends ISerialRequest{
    private static final String TAG = "QueryCarInfoRequest";

    public QueryCarInfoRequest(@NonNull GetHelperListener getHelperListener) {
        super("84", getHelperListener);
    }
