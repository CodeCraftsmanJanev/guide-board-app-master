...
//        mRailway = getResources().getDrawable(R.drawable.ic_railway);
        mBus = ResourceUtils.getDrawable(R.mipmap.ic_launcher);
        mBusSmall = ResourceUtils.getDrawable(R.mipmap.ic_launcher);
        mCurrentPosition = ResourceUtils.getDrawable(R.mipmap.ic_launcher);
        mCurrentPositionLocation = ResourceUtils.getDrawable(R.mipmap.ic_launcher);
        mRailway = ResourceUtils.getDrawable(R.mipmap.ic_launcher);
        ...
        mColorPass = Color.parseColor("#C0C0C0");
        mColorUnreach = Color.parseColor("#1FB562");
        ...
        mNumTxtSize = 30 * scaleDensity;
        mStationNameTxtSize = 34 * scaleDensity;
        mSelectedTxtSize = 40 * scaleDensity;
    }
