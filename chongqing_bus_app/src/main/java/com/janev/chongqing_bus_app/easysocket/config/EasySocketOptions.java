package com.janev.chongqing_bus_app.easysocket.config;

import com.janev.chongqing_bus_app.easysocket.config.CallbackIDFactory;
import com.janev.chongqing_bus_app.easysocket.config.SocketFactory;
import com.janev.chongqing_bus_app.easysocket.config.SocketSSLConfig;
import com.janev.chongqing_bus_app.easysocket.connection.reconnect.AbsReconnection;
...
import com.janev.chongqing_bus_app.easysocket.interfaces.config.IMessageProtocol;
...
public class EasySocketOptions {
     ...
     * 安全套接字相关配置
     */
    private com.janev.chongqing_bus_app.easysocket.config.SocketSSLConfig easySSLConfig;
    /**
     * socket工厂
     */
    private com.janev.chongqing_bus_app.easysocket.config.SocketFactory socketFactory;
    /**
     * 实现回调功能需要callbackID，而callbackID是保存在发送消息和应答消息中的，此工厂用来获取socket消息中
     * 保存callbackID值的key，比如json格式中的key-value中的key
     */
    private com.janev.chongqing_bus_app.easysocket.config.CallbackIDFactory callbackIDFactory;
    /**
     * 请求超时时间，单位毫秒
     */
    ...
    public static class Builder {
         ...
         */
        public Builder setCallbackIDFactory(com.janev.chongqing_bus_app.easysocket.config.CallbackIDFactory callbackIDFactory) {
         ...
         * @return
         */
        public Builder setEasySSLConfig(com.janev.chongqing_bus_app.easysocket.config.SocketSSLConfig easySSLConfig) {
         ...
         * @return
         */
        public Builder setSocketFactory(com.janev.chongqing_bus_app.easysocket.config.SocketFactory socketFactory) {
    ...
    public com.janev.chongqing_bus_app.easysocket.config.SocketSSLConfig getEasySSLConfig() {
        return easySSLConfig;
    }

    public com.janev.chongqing_bus_app.easysocket.config.SocketFactory getSocketFactory() {
    ...
    public com.janev.chongqing_bus_app.easysocket.config.CallbackIDFactory getCallbackIDFactory() {
